...
import (
	solana_storage "github.com/captainyugi00/yellowstone-geyser-proto/solana-storage"
...
// Symbols defined in public import of solana-storage.proto.

type RewardType = solana_storage.RewardType

const RewardType_Unspecified = solana_storage.RewardType_Unspecified
const RewardType_Fee = solana_storage.RewardType_Fee
const RewardType_Rent = solana_storage.RewardType_Rent
const RewardType_Staking = solana_storage.RewardType_Staking
const RewardType_Voting = solana_storage.RewardType_Voting

var RewardType_name = solana_storage.RewardType_name
var RewardType_value = solana_storage.RewardType_value

type ConfirmedBlock = solana_storage.ConfirmedBlock
type ConfirmedTransaction = solana_storage.ConfirmedTransaction
type Transaction = solana_storage.Transaction
type Message = solana_storage.Message
type MessageHeader = solana_storage.MessageHeader
type MessageAddressTableLookup = solana_storage.MessageAddressTableLookup
type TransactionStatusMeta = solana_storage.TransactionStatusMeta
type TransactionError = solana_storage.TransactionError
type InnerInstructions = solana_storage.InnerInstructions
type InnerInstruction = solana_storage.InnerInstruction
type CompiledInstruction = solana_storage.CompiledInstruction
type TokenBalance = solana_storage.TokenBalance
type UiTokenAmount = solana_storage.UiTokenAmount
type ReturnData = solana_storage.ReturnData
type Reward = solana_storage.Reward
type Rewards = solana_storage.Rewards
type UnixTimestamp = solana_storage.UnixTimestamp
type BlockHeight = solana_storage.BlockHeight
...
type SubscribeUpdateTransactionInfo struct {
	...
	Transaction *solana_storage.Transaction           `protobuf:"bytes,3,opt,name=transaction,proto3" json:"transaction,omitempty"`
	Meta        *solana_storage.TransactionStatusMeta `protobuf:"bytes,4,opt,name=meta,proto3" json:"meta,omitempty"`
...
func (x *SubscribeUpdateTransactionInfo) GetTransaction() *solana_storage.Transaction {
	if x != nil {
		return x.Transaction
	}
	return nil
...
func (x *SubscribeUpdateTransactionInfo) GetMeta() *solana_storage.TransactionStatusMeta {
	if x != nil {
		return x.Meta
	}
	return nil
...
type SubscribeUpdateTransactionStatus struct {
	...
	Err       *solana_storage.TransactionError `protobuf:"bytes,5,opt,name=err,proto3" json:"err,omitempty"`
}
...
func (x *SubscribeUpdateTransactionStatus) GetErr() *solana_storage.TransactionError {
	if x != nil {
		return x.Err
	}
	return nil
...
type SubscribeUpdateBlock struct {
	...
	Rewards                  *solana_storage.Rewards           `protobuf:"bytes,3,opt,name=rewards,proto3" json:"rewards,omitempty"`
	BlockTime                *solana_storage.UnixTimestamp     `protobuf:"bytes,4,opt,name=block_time,json=blockTime,proto3" json:"block_time,omitempty"`
	BlockHeight              *solana_storage.BlockHeight       `protobuf:"bytes,5,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
...
func (x *SubscribeUpdateBlock) GetRewards() *solana_storage.Rewards {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *SubscribeUpdateBlock) GetBlockTime() *solana_storage.UnixTimestamp {
	if x != nil {
		return x.BlockTime
	}
	return nil
...
func (x *SubscribeUpdateBlock) GetBlockHeight() *solana_storage.BlockHeight {
	if x != nil {
...
func (x *SubscribeUpdateBlockMeta) GetRewards() *solana_storage.Rewards {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *SubscribeUpdateBlockMeta) GetBlockTime() *solana_storage.UnixTimestamp {
	if x != nil {
		return x.BlockTime
	}
	return nil
...
func (x *SubscribeUpdateBlockMeta) GetBlockHeight() *solana_storage.BlockHeight {
	if x != nil {
		return x.BlockHeight
	}
	return nil
...
var file_geyser_proto_rawDesc = []byte{
	...
	0x1d, 0x67, 0x65, 0x6e, 0x2d, 0x79, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x73, 0x74, 0x6f, 0x6e, 0x65,
	0x2d, 0x67, 0x65, 0x79, 0x73, 0x65, 0x72, 0x2f, 0x67, 0x65, 0x79, 0x73, 0x65, 0x72, 0x50, 0x00,
...
var file_geyser_proto_goTypes = []any{
	...
	(*solana_storage.Transaction)(nil),                 // 43: solana.storage.ConfirmedBlock.Transaction
	(*solana_storage.TransactionStatusMeta)(nil),       // 44: solana.storage.ConfirmedBlock.TransactionStatusMeta
	(*solana_storage.TransactionError)(nil),            // 45: solana.storage.ConfirmedBlock.TransactionError
	(*solana_storage.Rewards)(nil),                     // 46: solana.storage.ConfirmedBlock.Rewards
	(*solana_storage.UnixTimestamp)(nil),               // 47: solana.storage.ConfirmedBlock.UnixTimestamp
	(*solana_storage.BlockHeight)(nil),                 // 48: solana.storage.ConfirmedBlock.BlockHeight
}
...
func file_geyser_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_geyser_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[24].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[25].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[26].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[27].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[28].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[29].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[30].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[31].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[32].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[33].Exporter = func(v any, i int) any {
		...
		file_geyser_proto_msgTypes[34].Exporter = func(v any, i int) any {
